...
- Hiểu các dịch vụ AWS cơ bản, cách dùng Console và CLI.
- Khởi tạo nền tảng về storage và identity access management.

### Các công việc cần triển khai trong tuần này:

| Thứ | Công việc | Ngày bắt đầu | Ngày hoàn thành | Nguồn tài liệu |
| --- | --- | --- | --- | --- |
| 2 | - Làm quen với các thành viên trong team<br>- Đọc và ghi chú nội quy, quy định tại đơn vị thực tập | 20/04/2026 | 20/04/2026 | https://00001.awsstudygroup.com/ |
...
- Nắm vững các dịch vụ nền tảng về lưu trữ và định danh (S3, IAM, Cognito).
- Tạo được Cognito User Pool ban đầu để phát hành JWT token cho các giai đoạn sau.
